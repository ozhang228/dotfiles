...
return {
  cmd = {
    "clangd",
    "--background-index-priority=low", -- index without stealing CPU, default "normal"
    "--clang-tidy", -- enable clang-tidy diagnostics, off by default
    "--completion-style=detailed", -- full signature per-overload in completion, default "bundled"
    "--function-arg-placeholders=false", -- don't insert $1/$2 placeholders, just the parens
    "--pch-storage=memory", -- faster completion, uses more RAM vs default "disk"
  },
