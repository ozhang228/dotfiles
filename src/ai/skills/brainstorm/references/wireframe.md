...
`WireframeBlock` content, shared word for word by `the visual plan workflow` and
`the visual recap workflow`. Read it in full before authoring ANY wireframe; do not
